...
#define PACKET_TAHA 20 // 12 bytes Euler angles, 36 bytes calibrated sensor readings, 4 byte G_Dt
using namespace std;
...
struct PacketTaha {
	//float accX, accY, accZ, magX, magY, magZ, gyroX, gyroY, gyroZ; // look at Razor_AHRS.ino to see the order
	float yaw, pitch, roll; // look at Razor_AHRS -> Output.ino to see the order
	float G_Dt; // integration time for gyros - see Razor_AHRS.ino and DCM.ino for more
