...
if (choice == 1)
    ...
    gyroDataForBiasEstimationName = '../bolz_hall_gyro_data_for_bias_estimation_wired_57600_8.txt';
    %gyroDataForBiasEstimationName = '../bolz_hall_gyro_data_for_bias_estimation_wired_57600_5.txt';
    %gyroDataForBiasEstimationName = '../bolz_hall_gyro_data_for_bias_estimation_wired_57600.txt';
else if (choice == 2)
...
if (choice == 1)
    ...
    pedestrianTraverseName = '../bolz_hall_wired_57600_8.txt';
...
sf = 1; % scale factor
if (choice == 1)
    sf = 1.09; % 1.09 for bolz 1.11 it was 1.15 for _2 1.16 for _4 1.06 for _5
    angle = 189; % 187 or 182.
else if (choice == 2)
    sf = 1.1; % scale factor
