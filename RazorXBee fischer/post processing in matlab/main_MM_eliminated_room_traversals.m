...
figure(3); set(figure(3),'position',[1 59 1114 671]); %set(gcf,'position',[371 151 535 422]);
imshow(staticFloorPDF{choice},'colormap',jet(255));
colormap jet;
set(gca, 'YDir', 'reverse');
hold on;
if (choice2 == 12)
%     plot(finalEstimateRotatedTranslatedhkmin3(1,strideNumber-20:strideNumber-20+probStrides),...
%         finalEstimateRotatedTranslatedhkmin3(2,strideNumber-20:strideNumber-20+probStrides),'g-x','linewidth',1.5);
%     plot(finalEstimateRotatedTranslatedhkmin2(1,strideNumber-19:strideNumber-19+probStrides),...
%         finalEstimateRotatedTranslatedhkmin2(2,strideNumber-19:strideNumber-19+probStrides),'y-x','linewidth',1.5);
%     plot(finalEstimateRotatedTranslatedhkmin1(1,strideNumber-18:strideNumber-18+probStrides),...
%         finalEstimateRotatedTranslatedhkmin1(2,strideNumber-18:strideNumber-18+probStrides),'y-x','linewidth',1.5,'color',[1 0.5 0]);
%     plot(finalEstimateRotatedTranslatedhk(1,strideNumber-17:strideNumber-17+probStrides),...
%         finalEstimateRotatedTranslatedhk(2,strideNumber-17:strideNumber-17+probStrides),'y-x','linewidth',1.5,'color',[1 0 0.5]);
%     plot(finalEstimateRotatedTranslatedhkplus1(1,strideNumber-16:strideNumber-16+probStrides),...
%         finalEstimateRotatedTranslatedhkplus1(2,strideNumber-16:strideNumber-16+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 1]);
%     finalEstimateRotatedTranslatedhkplus2(:,strideNumber-15) = finalEstimateRotatedTranslatedhkplus1(:,strideNumber-15);
%     plot(finalEstimateRotatedTranslatedhkplus2(1,strideNumber-15:strideNumber-15+probStrides),...
%         finalEstimateRotatedTranslatedhkplus2(2,strideNumber-15:strideNumber-15+probStrides),'y-x','linewidth',1.5,'color',[0.5 0 0.5]);
%     plot(finalEstimateRotatedTranslatedhkplus3(1,strideNumber-14:strideNumber-14+probStrides),...
%         finalEstimateRotatedTranslatedhkplus3(2,strideNumber-14:strideNumber-14+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 0]);
...
%     figure(3);xlim([660 1410]);ylim([548 1018]);
else
...
%             figure(3); hold on; plot(imuPosition(1),imuPosition(2),'wx'); hold off;
        ...
        if (manual_switch == true)
            ...
            if ((i >= 17 && i <= strideNumber-16+50)) % added 50 to avoid
                f_staticFloor(:,:,i) = 255;
            end
            else if (choice2 == 16)
...
%%
figure(5); set(figure(5),'position',[1 59 1114 671]);
set(gcf,'position',[564 61 927 670]);
imshow(img); hold on;
...
if (choice2 == 6 || choice2 == 9)
    ...
    legend('error state KF with ZUPT','partial non-recursive Bayesian map-matching','start','stop');
    set(legend,'fontsize',16,'interpreter','latex','location','northeast');
    else
    legend('error state KF with ZUPT','non-recursive Bayesian map-matching with MHT','start','stop');
    set(legend,'fontsize',16,'interpreter','latex','location','northeast');
    end
end
if (choice2 ~= 6 && choice2 ~= 9)
...
plot(finalEstimate(1,strideNumber-20),finalEstimate(2,strideNumber-20),'kp','linewidth',2,'markerfacecolor','g','markersize',16);
plot(finalEstimate(1,strideNumber-19),finalEstimate(2,strideNumber-19),'kv','linewidth',2,'markerfacecolor','y','markersize',16);
plot(finalEstimate(1,strideNumber-18),finalEstimate(2,strideNumber-18),'ko','linewidth',2,'markerfacecolor',[1 0.5 0],'markersize',16);
plot(finalEstimate(1,strideNumber-17),finalEstimate(2,strideNumber-17),'ks','linewidth',2,'markerfacecolor',[1 0 0.5],'markersize',16);
...
hold off;
legend('complementary KF','non-recursive map-matching','pedestrian start',...
...
hkmin3angle = 62; % rotation for hypothesis k-3.
hkmin2angle = 29; % rotation for hypothesis k-2.
hkmin1angle = -13; % rotation for hypothesis k-1.
hkangle = -30; % rotation for hypothesis k-1.
hkplus1angle = -19; % rotation for hypothesis k-3.
hkplus2angle = -36; % rotation for hypothesis k-2.
hkplus3angle = -92; % rotation for hypothesis k-1.
...
hkmin3Translation = [-137;273]; % [-137;273]
finalEstimateRotatedTranslatedhkmin3 = finalEstimateRotatedhkmin3 + hkmin3Translation; % translation for hypothesis k-3
hkmin2Translation = finalEstimateRotatedhkmin2(:,strideNumber-19)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-20);%[-30; 140];
finalEstimateRotatedTranslatedhkmin2 = finalEstimateRotatedhkmin2 - hkmin2Translation; % translation for hypothesis k-2
hkmin1Translation = finalEstimateRotatedhkmin1(:,strideNumber-18)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-20);%[-30; 140];
finalEstimateRotatedTranslatedhkmin1 = finalEstimateRotatedhkmin1 - hkmin1Translation; % translation for hypothesis k-2
hkTranslation = finalEstimateRotatedhk(:,strideNumber-17)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-20);%[-30; 140];
finalEstimateRotatedTranslatedhk = finalEstimateRotatedhk - hkTranslation; % translation for hypothesis k-2
hkplus1Translation = finalEstimateRotatedhkplus1(:,strideNumber-16)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-20);%[-30; 140];
finalEstimateRotatedTranslatedhkplus1 = finalEstimateRotatedhkplus1 - hkplus1Translation; % translation for hypothesis k-2
hkplus2Translation = finalEstimateRotatedhkplus2(:,strideNumber-15)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-20);%[-30; 140];
finalEstimateRotatedTranslatedhkplus2 = finalEstimateRotatedhkplus2 - hkplus2Translation; % translation for hypothesis k-2
hkplus3Translation = finalEstimateRotatedhkplus3(:,strideNumber-14)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-20);%[-30; 140];
...
if (choice == 1 || choice == 2)
    if (showRotated)
        ...
        plot(finalEstimateRotatedhkplus3(1,strideNumber-14),finalEstimateRotatedhkplus3(2,strideNumber-14),'ks','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkplus3(1,strideNumber-15),finalEstimateRotatedhkplus3(2,strideNumber-15),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
...
plot(finalEstimateRotatedTranslatedhkplus3(1,strideNumber-14:strideNumber-14+probStrides),...
    finalEstimateRotatedTranslatedhkplus3(2,strideNumber-14:strideNumber-14+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 0]);
plot(finalEstimateRotatedTranslatedhkplus2(1,18),...
    finalEstimateRotatedTranslatedhkplus2(2,18),'k<','linewidth',1.5,'markersize',16,'markerfacecolor','k');
plot(finalEstimateRotatedTranslatedhkplus2(1,18:end),...
    finalEstimateRotatedTranslatedhkplus2(2,18:end),'r-','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkplus2(1,18),...
    finalEstimateRotatedTranslatedhkplus2(2,18),'rx','linewidth',1.5);
%plot(finalEstimateRotatedTranslatedhkmin3(1,strideNumber-20),finalEstimateRotatedTranslatedhkmin3(2,strideNumber-20),'kp','linewidth',2,'markerfacecolor','g','markersize',16);
%plot(finalEstimateRotatedTranslated(1,strideNumber-21),finalEstimateRotatedTranslated(2,strideNumber-21),'ko','linewidth',2,'markerfacecolor','g','markersize',16);
hold off; legend('hypothesis k-3 trajectory','hypothesis k-2 trajectory',...
    'hypothesis k-1 trajectory','hypothesis k trajectory',...
    'hypothesis k+1 trajectory','hypothesis k+2 trajectory',...
    'hypothesis k+3 trajectory');
...
for i=1:probStrides
    probStridesVectorhkmin3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin3(:,strideNumber-20+i),0,0,0,0);
    probStridesVectorhkmin2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin2(:,strideNumber-19+i),0,0,0,0);
    probStridesVectorhkmin1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin1(:,strideNumber-18+i),0,0,0,0);
    probStridesVectorhk(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhk(:,strideNumber-17+i),0,0,0,0);
    probStridesVectorhkplus1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus1(:,strideNumber-16+i),0,0,0,0);
    probStridesVectorhkplus2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus2(:,strideNumber-15+i),0,0,0,0);
    probStridesVectorhkplus3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus3(:,strideNumber-14+i),0,0,0,0);
end
...
% the hypothesis with the most probability has the max rotation and translation
% the angle and the shift is gradually distributed to the strides in the room
...
fprintf('\n');
legend('error state KF with ZUPT','partial non-recursive Bayesian map-matching',...
    'start','stop','room trajectory corrections');
set(legend,'fontsize',16,'interpreter','latex','location','northeast');
hold off;
