...
lastFigNumber = 7;
rooms.room1.numberOfHyp = 56;
hypRotAngle = zeros(1,rooms.room1.numberOfHyp);
hypRotAngle(1)=185;hypRotAngle(2)=152;hypRotAngle(3)=115;hypRotAngle(4)=96;
hypRotAngle(5)=89;hypRotAngle(6)=92;hypRotAngle(7)=24;hypRotAngle(8)=-73;
hypRotAngle(9)=-84;hypRotAngle(10)=-80;hypRotAngle(11)=-109;hypRotAngle(12)=160;
hypRotAngle(13)=102;hypRotAngle(14)=90;hypRotAngle(15)=92;hypRotAngle(16)=0;
hypRotAngle(17)=-69; hypRotAngle(18)=-82; hypRotAngle(19)=-82;
hypRotAngle(20)=-160; hypRotAngle(21)=118; hypRotAngle(22)=89;
hypRotAngle(23)=92; hypRotAngle(24)=54; hypRotAngle(25)=-54;
hypRotAngle(26)=-86; hypRotAngle(27)=-80; hypRotAngle(28)=-105;
hypRotAngle(29)=166; hypRotAngle(30)=102; hypRotAngle(31)=95;
hypRotAngle(32)=95; hypRotAngle(33)=70; hypRotAngle(34)=-40;
hypRotAngle(35)=-82; hypRotAngle(36)=-80; hypRotAngle(37)=-77;
hypRotAngle(38)=-142; hypRotAngle(39)=126; hypRotAngle(40)=99;
hypRotAngle(41)=101; hypRotAngle(42)=85; hypRotAngle(43)=-20;
hypRotAngle(44)=-75; hypRotAngle(45)=-85; hypRotAngle(46)=-87;
hypRotAngle(47)=-79; hypRotAngle(48)=0; hypRotAngle(49)=5; % hypRotAngle(48)=10
hypRotAngle(50)=-57; hypRotAngle(51)=-88; hypRotAngle(52)=-88;
hypRotAngle(53)=-84;hypRotAngle(54)=-90;hypRotAngle(55)=-90;
hypRotAngle(56)=-86;
% -10 -5 hypRotAngle +5 +10 all options yield 5 hypothesis from one
hypRotAngle = hypRotAngle + 5; 
...
legend(['$\displaystyle \sum_{i=1}^{10} h_{', num2str(rooms.room1.lastHyp), '}^i = ', ...
    num2str(maxValue),'$']);
...
hypRotAngle(1)=160; hypRotAngle(2)=182;hypRotAngle(3)=185;hypRotAngle(4)=-147;
hypRotAngle(5)=-117;hypRotAngle(6)=-102;hypRotAngle(7)=-98;hypRotAngle(8)=-62;
hypRotAngle(9)=35;hypRotAngle(10)=79;hypRotAngle(11)=82;hypRotAngle(12)=89;
hypRotAngle(13)=-152;hypRotAngle(14)=-110;hypRotAngle(15)=-110;hypRotAngle(16)=-75;
hypRotAngle(17)=30; hypRotAngle(18)=75; hypRotAngle(19)=83;
hypRotAngle(20)=135; hypRotAngle(21)=-126; hypRotAngle(22)=-105;
hypRotAngle(23)=-112; hypRotAngle(24)=-30; hypRotAngle(25)=55;
hypRotAngle(26)=72; hypRotAngle(27)=95; hypRotAngle(28)=-159;
hypRotAngle(29)=-120; hypRotAngle(30)=102; hypRotAngle(31)=-65;
hypRotAngle(32)=28; hypRotAngle(33)=67; hypRotAngle(34)=60;
hypRotAngle(35)=110; hypRotAngle(36)=-155; hypRotAngle(37)=-120;
hypRotAngle(38)=-120; hypRotAngle(39)=-36; hypRotAngle(40)=39;
hypRotAngle(41)=51; hypRotAngle(42)=75; hypRotAngle(43)=160;
hypRotAngle(44)=-137; hypRotAngle(45)=-135; hypRotAngle(46)=-77;
hypRotAngle(47)=11; hypRotAngle(48)=82; hypRotAngle(49)=93; % hypRotAngle(48)=10
hypRotAngle(50)=20; hypRotAngle(51)=-82; hypRotAngle(52)=-153;
hypRotAngle(53)=-175;hypRotAngle(54)=-135;hypRotAngle(55)=-27;
hypRotAngle(56)=41;hypRotAngle(57)=71;hypRotAngle(58)=58;
hypRotAngle(59)=10;hypRotAngle(60)=-26;hypRotAngle(61)=-47;
hypRotAngle(62)=-52;hypRotAngle(63)=-38;hypRotAngle(64)=26;
hypRotAngle = hypRotAngle + 5; % -10 -5 hypRotAngle +5 +10 
...
% right angle that is 90 degrees and also + and - 5,10 degrees.
rooms.room4.numberOfHyp = 56;
close all; clear all; load room_4_hypotheses.mat;
subsequentStrides = 15;
hypRotAngle = zeros(1,rooms.room4.numberOfHyp);
hypRotAngle(1)=-175; hypRotAngle(2)=-170;hypRotAngle(3)=178;hypRotAngle(4)=135;
...
hypRotAngle(53)=-90; hypRotAngle(54)=-45; hypRotAngle(55)=0;
hypRotAngle(56)=66;
hypRotAngle = hypRotAngle + 25; % -10 -5 hypRotAngle +5 +10 
