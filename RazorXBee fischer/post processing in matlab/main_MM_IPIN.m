...
%             figure(3); hold on; plot(imuPosition(1),imuPosition(2),'wx'); hold off;
        ...
        if (manual_switch == true)
            if (choice2 == 6)
                if ((i >= 9 && i <=20) || (i >= 33 && i <=45) || ...
                        (i >= 63 && i <=75) || (i >= 103 && i <=119))
...
%%
figure(5); set(figure(5),'position',[1 59 1114 671],'papertype','a3');
set(gcf,'position',[564 61 927 670]);
imshow(img); hold on;
...
if (choice == 1 || choice == 2)
plot(mu(1,1:end),mu(2,1:end),'b-x','linewidth',1.5,'markersize',10); % this is IMU (EKF+DR+ZUPT) solution
...
set(legend,'fontsize',20,'interpreter','latex','location','northeast');
...
% print('four_times_spin','-dpdf','-opengl');
% if (choice2 ~= 6 && choice2 ~= 9)
%     figure(5);xlim([660 1410]);ylim([548 1018]);
% end
% figure(5); hold on; plot(finalEstimate(1,[9;20]),finalEstimate(2,[9;20]),'yo','linewidth',3); hold off;
% figure(5); hold on; plot(finalEstimate(1,[33;45]),finalEstimate(2,[33;45]),'yo','linewidth',3); hold off;
% figure(5); hold on; plot(finalEstimate(1,[63;75]),finalEstimate(2,[63;75]),'yo','linewidth',3); hold off;
% figure(5); hold on; plot(finalEstimate(1,[103;119]),finalEstimate(2,[103;119]),'yo','linewidth',3); hold off;
%%
...
figure(7); clf; set(gcf,'position',[364   388   716   242]);
hold on;
...
set(gca,'position',[0.1313    0.1777    0.8575    0.8104]);
set(gca,'xtick',[0:20:strideNumber],'xticklabel',{'','20','40',...
    '60','80','','','140','160','180','200',''},...
    'TickLabelInterpreter', 'latex');
set(gca,'ytick',[0 1],'yticklabels',{'map OFF','map ON'},'fontsize',15,...
    'TickLabelInterpreter', 'latex');