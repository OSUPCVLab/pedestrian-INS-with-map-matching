...
if (choice == 1)
    ...
    gyroDataForBiasEstimationName = '../caldwell_lab_gyro_data_for_bias_estimation_wired_57600_3.txt';
...
if (choice == 1)
    ...
    %pedestrianTraverseName = '../bolz_hall_wired_57600.txt';
        ...
        pedestrianTraverseName = '../caldwell_lab_wired_57600_3.txt';
...
stepp = 38; % first step in the room
plot(trajectoryPixels(1,strideIndexes(stepp)),trajectoryPixels(2,strideIndexes(stepp)),'go-','linewidth',2);
stepp2 = 55; % first step in the room
plot(trajectoryPixels(1,strideIndexes(stepp2)),trajectoryPixels(2,strideIndexes(stepp2)),'go-','linewidth',2);
stepp3 = strideNumber-109; % first step in the room
plot(trajectoryPixels(1,strideIndexes(stepp3)),trajectoryPixels(2,strideIndexes(stepp3)),'go-','linewidth',2);
stepp4 = strideNumber-44; % last step in the room
plot(trajectoryPixels(1,strideIndexes(stepp4)),trajectoryPixels(2,strideIndexes(stepp4)),'go-','linewidth',2);
stepp5 = strideNumber-8; % last step in the room
plot(trajectoryPixels(1,strideIndexes(stepp5)),trajectoryPixels(2,strideIndexes(stepp5)),'go-','linewidth',2);
hold off;
...
%             figure(3); hold on; plot(imuPosition(1),imuPosition(2),'wx'); hold off;
        ...
        if (manual_switch == true)
            if (choice == 2)
                if ((i >= 11)) % first step in the ECE LAB1
                    f_staticFloor(:,:,i) = 255;
                end
            end
        end
...
plot(finalEstimate(1,strideNumber-162),finalEstimate(2,strideNumber-162),'kp','linewidth',2,'markerfacecolor','g','markersize',16);
plot(finalEstimate(1,strideNumber-161),finalEstimate(2,strideNumber-161),'kv','linewidth',2,'markerfacecolor','y','markersize',16);
plot(finalEstimate(1,strideNumber-160),finalEstimate(2,strideNumber-160),'ko','linewidth',2,'markerfacecolor',[1 0.5 0],'markersize',16);
plot(finalEstimate(1,strideNumber-159),finalEstimate(2,strideNumber-159),'ks','linewidth',2,'markerfacecolor',[1 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-158),finalEstimate(2,strideNumber-158),'kh','linewidth',2,'markerfacecolor',[0 0.5 1],'markersize',16);
plot(finalEstimate(1,strideNumber-157),finalEstimate(2,strideNumber-157),'kd','linewidth',2,'markerfacecolor',[0.5 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-156),finalEstimate(2,strideNumber-156),'k^','linewidth',2,'markerfacecolor',[0 0.5 0],'markersize',16);
...
hkmin3angle = -4; % rotation for hypothesis k-3, computed wrt k-3 and k-4
hkmin2angle = -40; % rotation for hypothesis k-2.
hkmin1angle = -11; % rotation for hypothesis k-1.
hkangle = 0; % rotation for hypothesis k.
hkplus1angle = 50; % rotation for hypothesis k+1.
% burda kaldik kplus2
hkplus2angle = 88; % rotation for hypothesis k+2.
hkplus3angle = 90; % rotation for hypothesis k+3.
...
hkmin3Translation = [-17;83]; % [-137;273]
finalEstimateRotatedTranslatedhkmin3 = finalEstimateRotatedhkmin3 + hkmin3Translation; % translation for hypothesis k-3
hkmin2Translation = finalEstimateRotatedhkmin2(:,strideNumber-161)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-162);%[-30; 140];
finalEstimateRotatedTranslatedhkmin2 = finalEstimateRotatedhkmin2 - hkmin2Translation; % translation for hypothesis k-2
hkmin1Translation = finalEstimateRotatedhkmin1(:,strideNumber-160)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-162);%[-30; 140];
finalEstimateRotatedTranslatedhkmin1 = finalEstimateRotatedhkmin1 - hkmin1Translation; % translation for hypothesis k-2
hkTranslation = finalEstimateRotatedhk(:,strideNumber-159)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-162);%[-30; 140];
finalEstimateRotatedTranslatedhk = finalEstimateRotatedhk - hkTranslation; % translation for hypothesis k-2
hkplus1Translation = finalEstimateRotatedhkplus1(:,strideNumber-158)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-162);%[-30; 140];
finalEstimateRotatedTranslatedhkplus1 = finalEstimateRotatedhkplus1 - hkplus1Translation; % translation for hypothesis k-2
hkplus2Translation = finalEstimateRotatedhkplus2(:,strideNumber-157)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-162);%[-30; 140];
finalEstimateRotatedTranslatedhkplus2 = finalEstimateRotatedhkplus2 - hkplus2Translation; % translation for hypothesis k-2
hkplus3Translation = finalEstimateRotatedhkplus3(:,strideNumber-156)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-162);%[-30; 140];
...
if (choice == 1 || choice == 2)
    if (showRotated)
        ...
        plot(finalEstimateRotatedhkplus3(1,strideNumber-155),finalEstimateRotatedhkplus3(2,strideNumber-155),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkplus3(1,strideNumber-156),finalEstimateRotatedhkplus3(2,strideNumber-156),'ks','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkplus3(1,strideNumber-157),finalEstimateRotatedhkplus3(2,strideNumber-157),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
...
plot(finalEstimateRotatedTranslatedhkmin3(1,strideNumber-162:strideNumber-162+probStrides),...
    finalEstimateRotatedTranslatedhkmin3(2,strideNumber-162:strideNumber-162+probStrides),'g-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin2(1,strideNumber-161:strideNumber-161+probStrides),...
    finalEstimateRotatedTranslatedhkmin2(2,strideNumber-161:strideNumber-161+probStrides),'y-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin1(1,strideNumber-160:strideNumber-160+probStrides),...
    finalEstimateRotatedTranslatedhkmin1(2,strideNumber-160:strideNumber-160+probStrides),'y-x','linewidth',1.5,'color',[1 0.5 0]);
plot(finalEstimateRotatedTranslatedhk(1,strideNumber-159:strideNumber-159+probStrides),...
    finalEstimateRotatedTranslatedhk(2,strideNumber-159:strideNumber-159+probStrides),'y-x','linewidth',1.5,'color',[1 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus1(1,strideNumber-158:strideNumber-158+probStrides),...
    finalEstimateRotatedTranslatedhkplus1(2,strideNumber-158:strideNumber-158+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 1]);
plot(finalEstimateRotatedTranslatedhkplus2(1,strideNumber-157:strideNumber-157+probStrides),...
    finalEstimateRotatedTranslatedhkplus2(2,strideNumber-157:strideNumber-157+probStrides),'y-x','linewidth',1.5,'color',[0.5 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus3(1,strideNumber-156:strideNumber-156+probStrides),...
    finalEstimateRotatedTranslatedhkplus3(2,strideNumber-156:strideNumber-156+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 0]);
...
for i=1:probStrides
    probStridesVectorhkmin3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin3(:,strideNumber-162+i),0,0,0,0);
    probStridesVectorhkmin2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin2(:,strideNumber-161+i),0,0,0,0);
    probStridesVectorhkmin1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin1(:,strideNumber-160+i),0,0,0,0);
    probStridesVectorhk(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhk(:,strideNumber-159+i),0,0,0,0);
    probStridesVectorhkplus1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus1(:,strideNumber-158+i),0,0,0,0);
    probStridesVectorhkplus2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus2(:,strideNumber-157+i),0,0,0,0);
    probStridesVectorhkplus3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus3(:,strideNumber-156+i),0,0,0,0);
end
...
firstStride = 11; % 18
lastStride = strideNumber-159; % 16
...
% Room 260 traversal is over. The pedestrian is walking to Room 237 now.
%% illustration of hypotheses
...
plot(finalEstimate(1,1),finalEstimate(2,1),'ro','linewidth',2,'markerfacecolor','r','markeredgecolor','k','markersize',16);
plot(finalEstimate(1,end),finalEstimate(2,end),'gs','linewidth',2,'markerfacecolor','g','markeredgecolor','k','markersize',16);
plot(finalEstimate(1,strideNumber-112),finalEstimate(2,strideNumber-112),'kp','linewidth',2,'markerfacecolor','g','markersize',16);
plot(finalEstimate(1,strideNumber-111),finalEstimate(2,strideNumber-111),'kv','linewidth',2,'markerfacecolor','y','markersize',16);
plot(finalEstimate(1,strideNumber-110),finalEstimate(2,strideNumber-110),'ko','linewidth',2,'markerfacecolor',[1 0.5 0],'markersize',16);
plot(finalEstimate(1,strideNumber-109),finalEstimate(2,strideNumber-109),'ks','linewidth',2,'markerfacecolor',[1 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-108),finalEstimate(2,strideNumber-108),'kh','linewidth',2,'markerfacecolor',[0 0.5 1],'markersize',16);
plot(finalEstimate(1,strideNumber-107),finalEstimate(2,strideNumber-107),'kd','linewidth',2,'markerfacecolor',[0.5 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-106),finalEstimate(2,strideNumber-106),'k^','linewidth',2,'markerfacecolor',[0 0.5 0],'markersize',16);
% plot(finalEstimate(1,18),finalEstimate(2,18),'k<','linewidth',2,'markerfacecolor','k','markersize',16);
else (choice == 3)
plot(mu(1,1:end-30),mu(2,1:end-30), 'b-.','linewidth',2); % this is IMU (EKF+DR+ZUPT) solution
plot(finalEstimate(1,:),finalEstimate(2,:), 'r-','linewidth',2);
...
%% hypothesis k-3, k-2, k-1, k, k+1, k+2, k+3
% the angles are calculated according to IMU location & actual door location
hkmin3angle = 25; % rotation for hypothesis k-3, computed wrt k-3 and k-4
hkmin2angle = 22; % rotation for hypothesis k-2.
hkmin1angle = 22; % rotation for hypothesis k-1.
hkangle = -5; % rotation for hypothesis k.
hkplus1angle = -15; % rotation for hypothesis k+1.
% burda kaldik kplus2
hkplus2angle = -50; % rotation for hypothesis k+2.
hkplus3angle = -80; % rotation for hypothesis k+3.
% for each hypothesis, the rotation matrix is wrt to actual door location
rotation_matrixkmin3angle = [cosd(hkmin3angle) -sind(hkmin3angle);
    sind(hkmin3angle) cosd(hkmin3angle)];
rotation_matrixkmin2angle = [cosd(hkmin2angle) -sind(hkmin2angle);
...
%door216Location = [760.4018;999.5193];
hkmin3Translation = [-105;-250]; % [-137;273]
finalEstimateRotatedTranslatedhkmin3 = finalEstimateRotatedhkmin3 + hkmin3Translation; % translation for hypothesis k-3
hkmin2Translation = finalEstimateRotatedhkmin2(:,strideNumber-111)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-112);%[-30; 140];
finalEstimateRotatedTranslatedhkmin2 = finalEstimateRotatedhkmin2 - hkmin2Translation; % translation for hypothesis k-2
hkmin1Translation = finalEstimateRotatedhkmin1(:,strideNumber-110)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-112);%[-30; 140];
finalEstimateRotatedTranslatedhkmin1 = finalEstimateRotatedhkmin1 - hkmin1Translation; % translation for hypothesis k-2
hkTranslation = finalEstimateRotatedhk(:,strideNumber-109)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-112);%[-30; 140];
finalEstimateRotatedTranslatedhk = finalEstimateRotatedhk - hkTranslation; % translation for hypothesis k-2
hkplus1Translation = finalEstimateRotatedhkplus1(:,strideNumber-108)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-112);%[-30; 140];
finalEstimateRotatedTranslatedhkplus1 = finalEstimateRotatedhkplus1 - hkplus1Translation; % translation for hypothesis k-2
hkplus2Translation = finalEstimateRotatedhkplus2(:,strideNumber-107)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-112);%[-30; 140];
finalEstimateRotatedTranslatedhkplus2 = finalEstimateRotatedhkplus2 - hkplus2Translation; % translation for hypothesis k-2
hkplus3Translation = finalEstimateRotatedhkplus3(:,strideNumber-106)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-112);%[-30; 140];
finalEstimateRotatedTranslatedhkplus3 = finalEstimateRotatedhkplus3 - hkplus3Translation; % translation for hypothesis k-2
probStrides = 10;
...
if (choice == 1 || choice == 2)
    if (showRotated)
        plot(finalEstimateRotatedhkplus3(1,1:end),finalEstimateRotatedhkplus3(2,1:end),'r-x','linewidth',1.5);
%         plot(finalEstimateRotatedhkmin3(1,strideNumber-111),finalEstimateRotatedhkmin3(2,strideNumber-111),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkplus3(1,strideNumber-106),finalEstimateRotatedhkplus3(2,strideNumber-106),'ks','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkplus3(1,strideNumber-107),finalEstimateRotatedhkplus3(2,strideNumber-107),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
        % we can take stride k-2 to calculate the heading of the current hypothesis
        %plot(finalEstimateRotatedhkplus3(1,strideNumber-16),finalEstimateRotatedhkplus3(2,strideNumber-16),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
    end
else (choice == 3)
...
plot(finalEstimateRotatedTranslatedhkmin3(1,strideNumber-112:strideNumber-112+probStrides),...
    finalEstimateRotatedTranslatedhkmin3(2,strideNumber-112:strideNumber-112+probStrides),'g-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin2(1,strideNumber-111:strideNumber-111+probStrides),...
    finalEstimateRotatedTranslatedhkmin2(2,strideNumber-111:strideNumber-111+probStrides),'y-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin1(1,strideNumber-110:strideNumber-110+probStrides),...
    finalEstimateRotatedTranslatedhkmin1(2,strideNumber-110:strideNumber-110+probStrides),'y-x','linewidth',1.5,'color',[1 0.5 0]);
plot(finalEstimateRotatedTranslatedhk(1,strideNumber-109:strideNumber-109+probStrides),...
    finalEstimateRotatedTranslatedhk(2,strideNumber-109:strideNumber-109+probStrides),'y-x','linewidth',1.5,'color',[1 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus1(1,strideNumber-108:strideNumber-108+probStrides),...
    finalEstimateRotatedTranslatedhkplus1(2,strideNumber-108:strideNumber-108+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 1]);
plot(finalEstimateRotatedTranslatedhkplus2(1,strideNumber-107:strideNumber-107+probStrides),...
    finalEstimateRotatedTranslatedhkplus2(2,strideNumber-107:strideNumber-107+probStrides),'y-x','linewidth',1.5,'color',[0.5 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus3(1,strideNumber-106:strideNumber-106+probStrides),...
    finalEstimateRotatedTranslatedhkplus3(2,strideNumber-106:strideNumber-106+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 0]);
hold off; legend('hypothesis k-3 trajectory','hypothesis k-2 trajectory',...
    'hypothesis k-1 trajectory','hypothesis k trajectory',...
    'hypothesis k+1 trajectory','hypothesis k+2 trajectory',...
    'hypothesis k+3 trajectory');
...
probStridesVectorhkplus3 = zeros(1,probStrides);
for i=1:probStrides
    probStridesVectorhkmin3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin3(:,strideNumber-112+i),0,0,0,0);
    probStridesVectorhkmin2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin2(:,strideNumber-111+i),0,0,0,0);
    probStridesVectorhkmin1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin1(:,strideNumber-110+i),0,0,0,0);
    probStridesVectorhk(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhk(:,strideNumber-109+i),0,0,0,0);
    probStridesVectorhkplus1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus1(:,strideNumber-108+i),0,0,0,0);
    probStridesVectorhkplus2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus2(:,strideNumber-107+i),0,0,0,0);
    probStridesVectorhkplus3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus3(:,strideNumber-106+i),0,0,0,0);
end
...
yticklabels({'','.2','.4','.6','.8','1'});
set(gca,'GridLineStyle','--','position',[0.1442 0.1221 0.2345 0.3216]);
%% gradual correction for the trajectory in the room 271
% the hypothesis (stride) with the highest probability has the max rotation and 
% translation. the angle and the shift is gradually distributed to the strides in 
% the room. the very first stride in the room is applied least rotation and shift.
...
% hkplus2angle = -36; % this is the most voted hypothesis
firstStride = stepp2; % 18
lastStride = stepp3; % 16
roomStrides = lastStride-firstStride;
translationReference = finalEstimateRotatedTranslatedhk(:,lastStride);
for i = 0:roomStrides
    angleTemp = hkangle*(roomStrides-i)/roomStrides;
...
set(legend,'fontsize',16,'interpreter','latex','location','northwest');
% figure(11);xlim([660 1410]);ylim([548 1018]);
% Room 237 traversal is over. The pedestrian is going to Room 277 now.
% %% illustration of hypotheses
...
plot(finalEstimate(1,1),finalEstimate(2,1),'ro','linewidth',2,'markerfacecolor','r','markeredgecolor','k','markersize',16);
plot(finalEstimate(1,end),finalEstimate(2,end),'gs','linewidth',2,'markerfacecolor','g','markeredgecolor','k','markersize',16);
plot(finalEstimate(1,strideNumber-12),finalEstimate(2,strideNumber-12),'kp','linewidth',2,'markerfacecolor','g','markersize',16);
plot(finalEstimate(1,strideNumber-11),finalEstimate(2,strideNumber-11),'kv','linewidth',2,'markerfacecolor','y','markersize',16);
plot(finalEstimate(1,strideNumber-10),finalEstimate(2,strideNumber-10),'ko','linewidth',2,'markerfacecolor',[1 0.5 0],'markersize',16);
plot(finalEstimate(1,strideNumber-9),finalEstimate(2,strideNumber-9),'ks','linewidth',2,'markerfacecolor',[1 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-8),finalEstimate(2,strideNumber-8),'kh','linewidth',2,'markerfacecolor',[0 0.5 1],'markersize',16);
plot(finalEstimate(1,strideNumber-7),finalEstimate(2,strideNumber-7),'kd','linewidth',2,'markerfacecolor',[0.5 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-6),finalEstimate(2,strideNumber-6),'k^','linewidth',2,'markerfacecolor',[0 0.5 0],'markersize',16);
% plot(finalEstimate(1,18),finalEstimate(2,18),'k<','linewidth',2,'markerfacecolor','k','markersize',16);
else (choice == 3)
plot(mu(1,1:end-30),mu(2,1:end-30), 'b-.','linewidth',2); % this is IMU (EKF+DR+ZUPT) solution
plot(finalEstimate(1,:),finalEstimate(2,:), 'r-','linewidth',2);
...
%% hypothesis k-3, k-2, k-1, k, k+1, k+2, k+3
% the angles are calculated according to IMU location & actual door location
hkmin3angle = 0; % rotation for hypothesis k-3, computed wrt k-3 and k-4
hkmin2angle = 0; % rotation for hypothesis k-2.
hkmin1angle = -8; % rotation for hypothesis k-1.
hkangle = -9; % rotation for hypothesis k.
hkplus1angle = -24; % rotation for hypothesis k+1.
% burda kaldik kplus2
hkplus2angle = -85; % rotation for hypothesis k+2.
hkplus3angle = -90; % rotation for hypothesis k+3.
% for each hypothesis, the rotation matrix is wrt to actual door location
rotation_matrixkmin3angle = [cosd(hkmin3angle) -sind(hkmin3angle);
    sind(hkmin3angle) cosd(hkmin3angle)];
...
%door216Location = [760.4018;999.5193];
hkmin3Translation = [130;-24]; % [-137;273]
finalEstimateRotatedTranslatedhkmin3 = finalEstimateRotatedhkmin3 + hkmin3Translation; % translation for hypothesis k-3
hkmin2Translation = finalEstimateRotatedhkmin2(:,strideNumber-11)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-12);%[-30; 140];
finalEstimateRotatedTranslatedhkmin2 = finalEstimateRotatedhkmin2 - hkmin2Translation; % translation for hypothesis k-2
hkmin1Translation = finalEstimateRotatedhkmin1(:,strideNumber-10)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-12);%[-30; 140];
finalEstimateRotatedTranslatedhkmin1 = finalEstimateRotatedhkmin1 - hkmin1Translation; % translation for hypothesis k-2
hkTranslation = finalEstimateRotatedhk(:,strideNumber-9)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-12);%[-30; 140];
finalEstimateRotatedTranslatedhk = finalEstimateRotatedhk - hkTranslation; % translation for hypothesis k-2
hkplus1Translation = finalEstimateRotatedhkplus1(:,strideNumber-8)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-12);%[-30; 140];
finalEstimateRotatedTranslatedhkplus1 = finalEstimateRotatedhkplus1 - hkplus1Translation; % translation for hypothesis k-2
hkplus2Translation = finalEstimateRotatedhkplus2(:,strideNumber-7)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-12);%[-30; 140];
finalEstimateRotatedTranslatedhkplus2 = finalEstimateRotatedhkplus2 - hkplus2Translation; % translation for hypothesis k-2
hkplus3Translation = finalEstimateRotatedhkplus3(:,strideNumber-6)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-12);%[-30; 140];
finalEstimateRotatedTranslatedhkplus3 = finalEstimateRotatedhkplus3 - hkplus3Translation; % translation for hypothesis k-2
probStrides = 6;
...
if (choice == 1 || choice == 2)
    if (showRotated)
        plot(finalEstimateRotatedhkplus3(1,1:end),finalEstimateRotatedhkplus3(2,1:end),'r-x','linewidth',1.5);
%         plot(finalEstimateRotatedhkplus3(1,strideNumber-88),finalEstimateRotatedhkplus3(2,strideNumber-88),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkplus3(1,strideNumber-6),finalEstimateRotatedhkplus3(2,strideNumber-6),'ks','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkplus3(1,strideNumber-7),finalEstimateRotatedhkplus3(2,strideNumber-7),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
        % we can take stride k-2 to calculate the heading of the current hypothesis
        %plot(finalEstimateRotatedhkplus3(1,strideNumber-16),finalEstimateRotatedhkplus3(2,strideNumber-16),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
    end
else (choice == 3)
...
plot(finalEstimateRotatedTranslatedhkmin3(1,strideNumber-12:strideNumber-12+probStrides),...
    finalEstimateRotatedTranslatedhkmin3(2,strideNumber-12:strideNumber-12+probStrides),'g-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin2(1,strideNumber-11:strideNumber-11+probStrides),...
    finalEstimateRotatedTranslatedhkmin2(2,strideNumber-11:strideNumber-11+probStrides),'y-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin1(1,strideNumber-10:strideNumber-10+probStrides),...
    finalEstimateRotatedTranslatedhkmin1(2,strideNumber-10:strideNumber-10+probStrides),'y-x','linewidth',1.5,'color',[1 0.5 0]);
plot(finalEstimateRotatedTranslatedhk(1,strideNumber-9:strideNumber-9+probStrides),...
    finalEstimateRotatedTranslatedhk(2,strideNumber-9:strideNumber-9+probStrides),'y-x','linewidth',1.5,'color',[1 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus1(1,strideNumber-8:strideNumber-8+probStrides),...
    finalEstimateRotatedTranslatedhkplus1(2,strideNumber-8:strideNumber-8+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 1]);
plot(finalEstimateRotatedTranslatedhkplus2(1,strideNumber-7:strideNumber-7+probStrides),...
    finalEstimateRotatedTranslatedhkplus2(2,strideNumber-7:strideNumber-7+probStrides),'y-x','linewidth',1.5,'color',[0.5 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus3(1,strideNumber-6:strideNumber-6+probStrides),...
    finalEstimateRotatedTranslatedhkplus3(2,strideNumber-6:strideNumber-6+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 0]);
hold off; legend('hypothesis k-3 trajectory','hypothesis k-2 trajectory',...
    'hypothesis k-1 trajectory','hypothesis k trajectory',...
    'hypothesis k+1 trajectory','hypothesis k+2 trajectory',...
    'hypothesis k+3 trajectory');
...
probStridesVectorhkplus3 = zeros(1,probStrides);
for i=1:probStrides
    probStridesVectorhkmin3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin3(:,strideNumber-12+i),0,0,0,0);
    probStridesVectorhkmin2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin2(:,strideNumber-11+i),0,0,0,0);
    probStridesVectorhkmin1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin1(:,strideNumber-10+i),0,0,0,0);
    probStridesVectorhk(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhk(:,strideNumber-9+i),0,0,0,0);
    probStridesVectorhkplus1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus1(:,strideNumber-8+i),0,0,0,0);
    probStridesVectorhkplus2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus2(:,strideNumber-7+i),0,0,0,0);
    probStridesVectorhkplus3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus3(:,strideNumber-6+i),0,0,0,0);
end
...
yticklabels({'','.2','.4','.6','.8','1'});
set(gca,'GridLineStyle','--','position',[0.1442 0.1221 0.2345 0.3216]);
%% gradual correction for the trajectory in the room 277
% the hypothesis (stride) with the highest probability has the max rotation and 
% translation. the angle and the shift is gradually distributed to the strides in 
% the room. the very first stride in the room is applied least rotation and shift.
...
% hkplus2angle = -36; % this is the most voted hypothesis
firstStride = stepp4; % 18
lastStride = stepp5-1; % 16
roomStrides = lastStride-firstStride;
translationReference = finalEstimateRotatedTranslatedhk(:,lastStride);
for i = 0:roomStrides
    angleTemp = hkangle*(roomStrides-i)/roomStrides;
