...
if (choice == 1)
    gyroDataForBiasEstimationName = '../bolz_hall_gyro_data_for_bias_estimation_NGIMU_4.csv';
else if (choice == 2)
    gyroDataForBiasEstimationName = '../caldwell_gyro_data_for_bias_estimation_NGIMU_0.csv';
    else if (choice == 3)
...
if (choice == 1)
    pedestrianTraverseName = '../bolz_hall_NGIMU_4.csv';
    else if (choice == 2)
        pedestrianTraverseName = '../caldwell_NGIMU_0.csv';
...
sf = 1; % scale factor
if (choice == 1)
    sf = 1.06; % 1.09 for bolz 1.11 it was 1.15 for _2 1.16 for _4 1.06 for _5
    angle = 183; % 187 or 182.
else if (choice == 2)
    sf = 1.07; % scale factor
    angle = 183; % 181   1892     190 for multiple traverse
    else if (choice == 3)
