...
plot(finalEstimate(1,strideNumber-18),finalEstimate(2,strideNumber-18),'kp','linewidth',2,'markerfacecolor','g','markersize',16);
plot(finalEstimate(1,strideNumber-17),finalEstimate(2,strideNumber-17),'kv','linewidth',2,'markerfacecolor','y','markersize',16);
plot(finalEstimate(1,strideNumber-16),finalEstimate(2,strideNumber-16),'ko','linewidth',2,'markerfacecolor',[1 0.5 0],'markersize',16);
plot(finalEstimate(1,strideNumber-15),finalEstimate(2,strideNumber-15),'ks','linewidth',2,'markerfacecolor',[1 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-14),finalEstimate(2,strideNumber-14),'kh','linewidth',2,'markerfacecolor',[0 0.5 1],'markersize',16);
plot(finalEstimate(1,strideNumber-13),finalEstimate(2,strideNumber-13),'kd','linewidth',2,'markerfacecolor',[0.5 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-12),finalEstimate(2,strideNumber-12),'k^','linewidth',2,'markerfacecolor',[0 0.5 0],'markersize',16);
...
hkmin3angle = -67; % rotation for hypothesis k-3.
hkmin2angle = -92; % rotation for hypothesis k-2.
hkmin1angle = -86; % rotation for hypothesis k-1.
hkangle = -100; % rotation for hypothesis k.
hkplus1angle = -148; % rotation for hypothesis k+1.
hkplus2angle = 182; % rotation for hypothesis k+2.
hkplus3angle = 178; % rotation for hypothesis k+3.
...
hkmin3Translation = [-295;-258]; % [-137;273]
finalEstimateRotatedTranslatedhkmin3 = finalEstimateRotatedhkmin3 + hkmin3Translation; % translation for hypothesis k-3
hkmin2Translation = finalEstimateRotatedhkmin2(:,strideNumber-17)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-18);%[-30; 140];
finalEstimateRotatedTranslatedhkmin2 = finalEstimateRotatedhkmin2 - hkmin2Translation; % translation for hypothesis k-2
hkmin1Translation = finalEstimateRotatedhkmin1(:,strideNumber-16)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-18);%[-30; 140];
finalEstimateRotatedTranslatedhkmin1 = finalEstimateRotatedhkmin1 - hkmin1Translation; % translation for hypothesis k-2
hkTranslation = finalEstimateRotatedhk(:,strideNumber-15)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-18);%[-30; 140];
finalEstimateRotatedTranslatedhk = finalEstimateRotatedhk - hkTranslation; % translation for hypothesis k-2
hkplus1Translation = finalEstimateRotatedhkplus1(:,strideNumber-14)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-18);%[-30; 140];
finalEstimateRotatedTranslatedhkplus1 = finalEstimateRotatedhkplus1 - hkplus1Translation; % translation for hypothesis k-2
hkplus2Translation = finalEstimateRotatedhkplus2(:,strideNumber-13)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-18);%[-30; 140];
finalEstimateRotatedTranslatedhkplus2 = finalEstimateRotatedhkplus2 - hkplus2Translation; % translation for hypothesis k-2
hkplus3Translation = finalEstimateRotatedhkplus3(:,strideNumber-12)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-18);%[-30; 140];
...
if (choice == 1 || choice == 2)
    if (showRotated)
        plot(finalEstimateRotatedhkplus2(1,1:end),finalEstimateRotatedhkplus2(2,1:end),'r-x','linewidth',1.5);
        plot(finalEstimateRotatedhkplus2(1,strideNumber-13),finalEstimateRotatedhkplus2(2,strideNumber-13),'ks','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkplus2(1,strideNumber-14),finalEstimateRotatedhkplus2(2,strideNumber-14),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
...
plot(finalEstimateRotatedTranslatedhkmin3(1,strideNumber-18:strideNumber-18+probStrides),...
    finalEstimateRotatedTranslatedhkmin3(2,strideNumber-18:strideNumber-18+probStrides),'g-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin2(1,strideNumber-17:strideNumber-17+probStrides),...
    finalEstimateRotatedTranslatedhkmin2(2,strideNumber-17:strideNumber-17+probStrides),'y-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin1(1,strideNumber-16:strideNumber-16+probStrides),...
    finalEstimateRotatedTranslatedhkmin1(2,strideNumber-16:strideNumber-16+probStrides),'y-x','linewidth',1.5,'color',[1 0.5 0]);
plot(finalEstimateRotatedTranslatedhk(1,strideNumber-15:strideNumber-15+probStrides),...
    finalEstimateRotatedTranslatedhk(2,strideNumber-15:strideNumber-15+probStrides),'y-x','linewidth',1.5,'color',[1 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus1(1,strideNumber-14:strideNumber-14+probStrides),...
    finalEstimateRotatedTranslatedhkplus1(2,strideNumber-14:strideNumber-14+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 1]);
plot(finalEstimateRotatedTranslatedhkplus2(1,strideNumber-13:strideNumber-13+probStrides),...
    finalEstimateRotatedTranslatedhkplus2(2,strideNumber-13:strideNumber-13+probStrides),'y-x','linewidth',1.5,'color',[0.5 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus3(1,strideNumber-12:strideNumber-12+probStrides),...
    finalEstimateRotatedTranslatedhkplus3(2,strideNumber-12:strideNumber-12+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 0]);
...
for i=1:probStrides
    probStridesVectorhkmin3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin3(:,strideNumber-18+i),0,0,0,0);
    probStridesVectorhkmin2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin2(:,strideNumber-17+i),0,0,0,0);
    probStridesVectorhkmin1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin1(:,strideNumber-16+i),0,0,0,0);
    probStridesVectorhk(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhk(:,strideNumber-15+i),0,0,0,0);
    probStridesVectorhkplus1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus1(:,strideNumber-14+i),0,0,0,0);
    probStridesVectorhkplus2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus2(:,strideNumber-13+i),0,0,0,0);
    probStridesVectorhkplus3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus3(:,strideNumber-12+i),0,0,0,0);
end
