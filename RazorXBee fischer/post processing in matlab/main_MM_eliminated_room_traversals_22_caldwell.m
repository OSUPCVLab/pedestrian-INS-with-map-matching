...
plot(finalEstimate(1,strideNumber-115),finalEstimate(2,strideNumber-115),'kp','linewidth',2,'markerfacecolor','g','markersize',16);
plot(finalEstimate(1,strideNumber-114),finalEstimate(2,strideNumber-114),'kv','linewidth',2,'markerfacecolor','y','markersize',16);
plot(finalEstimate(1,strideNumber-113),finalEstimate(2,strideNumber-113),'ko','linewidth',2,'markerfacecolor',[1 0.5 0],'markersize',16);
plot(finalEstimate(1,strideNumber-112),finalEstimate(2,strideNumber-112),'ks','linewidth',2,'markerfacecolor',[1 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-111),finalEstimate(2,strideNumber-111),'kh','linewidth',2,'markerfacecolor',[0 0.5 1],'markersize',16);
plot(finalEstimate(1,strideNumber-110),finalEstimate(2,strideNumber-110),'kd','linewidth',2,'markerfacecolor',[0.5 0 0.5],'markersize',16);
plot(finalEstimate(1,strideNumber-109),finalEstimate(2,strideNumber-109),'k^','linewidth',2,'markerfacecolor',[0 0.5 0],'markersize',16);
...
hkmin3angle = -68; % rotation for hypothesis k-3, computed wrt k-3 and k-4
hkmin2angle = -74; % rotation for hypothesis k-2.
hkmin1angle = -77; % rotation for hypothesis k-1.
hkangle = -83; % rotation for hypothesis k.
hkplus1angle = -135; % rotation for hypothesis k+1.
% burda kaldik kplus2
hkplus2angle = -161; % rotation for hypothesis k+2.
hkplus3angle = -157; % rotation for hypothesis k+3.
...
hkmin3Translation = [488;530]; % [-137;273]
finalEstimateRotatedTranslatedhkmin3 = finalEstimateRotatedhkmin3 + hkmin3Translation; % translation for hypothesis k-3
hkmin2Translation = finalEstimateRotatedhkmin2(:,strideNumber-114)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-115);%[-30; 140];
finalEstimateRotatedTranslatedhkmin2 = finalEstimateRotatedhkmin2 - hkmin2Translation; % translation for hypothesis k-2
hkmin1Translation = finalEstimateRotatedhkmin1(:,strideNumber-113)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-115);%[-30; 140];
finalEstimateRotatedTranslatedhkmin1 = finalEstimateRotatedhkmin1 - hkmin1Translation; % translation for hypothesis k-2
hkTranslation = finalEstimateRotatedhk(:,strideNumber-112)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-115);%[-30; 140];
finalEstimateRotatedTranslatedhk = finalEstimateRotatedhk - hkTranslation; % translation for hypothesis k-2
hkplus1Translation = finalEstimateRotatedhkplus1(:,strideNumber-111)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-115);%[-30; 140];
finalEstimateRotatedTranslatedhkplus1 = finalEstimateRotatedhkplus1 - hkplus1Translation; % translation for hypothesis k-2
hkplus2Translation = finalEstimateRotatedhkplus2(:,strideNumber-110)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-115);%[-30; 140];
finalEstimateRotatedTranslatedhkplus2 = finalEstimateRotatedhkplus2 - hkplus2Translation; % translation for hypothesis k-2
hkplus3Translation = finalEstimateRotatedhkplus3(:,strideNumber-109)-finalEstimateRotatedTranslatedhkmin3(:,strideNumber-115);%[-30; 140];
...
if (choice == 1 || choice == 2)
    if (showRotated)
        ...
        plot(finalEstimateRotatedhkmin1(1,strideNumber-113),finalEstimateRotatedhkmin1(2,strideNumber-113),'ks','linewidth',2,'markerfacecolor','y','markersize',16);
        plot(finalEstimateRotatedhkmin1(1,strideNumber-114),finalEstimateRotatedhkmin1(2,strideNumber-114),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
...
plot(finalEstimateRotatedTranslatedhkmin3(1,strideNumber-115:strideNumber-115+probStrides),...
    finalEstimateRotatedTranslatedhkmin3(2,strideNumber-115:strideNumber-115+probStrides),'g-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin2(1,strideNumber-114:strideNumber-114+probStrides),...
    finalEstimateRotatedTranslatedhkmin2(2,strideNumber-114:strideNumber-114+probStrides),'y-x','linewidth',1.5);
plot(finalEstimateRotatedTranslatedhkmin1(1,strideNumber-113:strideNumber-113+probStrides),...
    finalEstimateRotatedTranslatedhkmin1(2,strideNumber-113:strideNumber-113+probStrides),'y-x','linewidth',1.5,'color',[1 0.5 0]);
plot(finalEstimateRotatedTranslatedhk(1,strideNumber-112:strideNumber-112+probStrides),...
    finalEstimateRotatedTranslatedhk(2,strideNumber-112:strideNumber-112+probStrides),'y-x','linewidth',1.5,'color',[1 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus1(1,strideNumber-111:strideNumber-111+probStrides),...
    finalEstimateRotatedTranslatedhkplus1(2,strideNumber-111:strideNumber-111+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 1]);
plot(finalEstimateRotatedTranslatedhkplus2(1,strideNumber-110:strideNumber-110+probStrides),...
    finalEstimateRotatedTranslatedhkplus2(2,strideNumber-110:strideNumber-110+probStrides),'y-x','linewidth',1.5,'color',[0.5 0 0.5]);
plot(finalEstimateRotatedTranslatedhkplus3(1,strideNumber-109:strideNumber-109+probStrides),...
    finalEstimateRotatedTranslatedhkplus3(2,strideNumber-109:strideNumber-109+probStrides),'y-x','linewidth',1.5,'color',[0 0.5 0]);
...
for i=1:probStrides
    probStridesVectorhkmin3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin3(:,strideNumber-115+i),0,0,0,0);
    probStridesVectorhkmin2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin2(:,strideNumber-114+i),0,0,0,0);
    probStridesVectorhkmin1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkmin1(:,strideNumber-113+i),0,0,0,0);
    probStridesVectorhk(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhk(:,strideNumber-112+i),0,0,0,0);
    probStridesVectorhkplus1(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus1(:,strideNumber-111+i),0,0,0,0);
    probStridesVectorhkplus2(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus2(:,strideNumber-110+i),0,0,0,0);
    probStridesVectorhkplus3(i) = imcrop_taha_subpixel_accuracy(choice,finalEstimateRotatedTranslatedhkplus3(:,strideNumber-109+i),0,0,0,0);
end
...
firstStride = 24; % 18
lastStride = strideNumber-113; % 16
...
% Room 237 traversal is over. The pedestrian is walking to Room 277 now.
%% illustration of hypotheses
...
%% hypothesis k-3, k-2, k-1, k, k+1, k+2, k+3
% the angles are calculated according to IMU location & actual door location
hkmin3angle = -2; % rotation for hypothesis k-3, computed wrt k-3 and k-4
hkmin2angle = -15; % rotation for hypothesis k-2.
hkmin1angle = -24; % rotation for hypothesis k-1.
hkangle = -18; % rotation for hypothesis k.
hkplus1angle = -85; % rotation for hypothesis k+1.
% burda kaldik kplus2
...
%door216Location = [760.4018;999.5193];
hkmin3Translation = [116;-4]; % [-137;273]
finalEstimateRotatedTranslatedhkmin3 = finalEstimateRotatedhkmin3 + hkmin3Translation; % translation for hypothesis k-3
...
% hkplus2angle = -36; % this is the most voted hypothesis
firstStride = 190; % 18
lastStride = strideNumber-10+1; % 16
roomStrides = lastStride-firstStride;
...
set(legend,'fontsize',16,'interpreter','latex','location','northwest');
% figure(11);xlim([660 1410]);ylim([548 1018]);
% Room 271 traversal is over. The pedestrian is has reached stop point now.
% %% illustration of hypotheses
...
% %% hypothesis k-3, k-2, k-1, k, k+1, k+2, k+3
% % the angles are calculated according to IMU location & actual door location
% hkmin3angle = -70; % rotation for hypothesis k-3, computed wrt k-3 and k-4
% hkmin2angle = -70; % rotation for hypothesis k-2.
% hkmin1angle = -26; % rotation for hypothesis k-1.
% hkangle = 33; % rotation for hypothesis k.
% hkplus1angle = 64; % rotation for hypothesis k+1.
% % burda kaldik kplus2
% hkplus2angle = 70; % rotation for hypothesis k+2.
% hkplus3angle = 107; % rotation for hypothesis k+3.
% % for each hypothesis, the rotation matrix is wrt to actual door location
% rotation_matrixkmin3angle = [cosd(hkmin3angle) -sind(hkmin3angle);
%     sind(hkmin3angle) cosd(hkmin3angle)];
% rotation_matrixkmin2angle = [cosd(hkmin2angle) -sind(hkmin2angle);
...
% 
% %door216Location = [760.4018;999.5193];
% hkmin3Translation = [-427;-1140]; % [-137;273]
% finalEstimateRotatedTranslatedhkmin3 = finalEstimateRotatedhkmin3 + hkmin3Translation; % translation for hypothesis k-3
...
%         plot(finalEstimateRotatedhkplus3(1,strideNumber-89),finalEstimateRotatedhkplus3(2,strideNumber-89),'ks','linewidth',2,'markerfacecolor','y','markersize',16);
%         plot(finalEstimateRotatedhkplus3(1,strideNumber-90),finalEstimateRotatedhkplus3(2,strideNumber-90),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
%         % we can take stride k-2 to calculate the heading of the current hypothesis
%         %plot(finalEstimateRotatedhkplus3(1,strideNumber-16),finalEstimateRotatedhkplus3(2,strideNumber-16),'ko','linewidth',2,'markerfacecolor','y','markersize',16);
%     end
% else (choice == 3)
