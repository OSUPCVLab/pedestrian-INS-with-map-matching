                                        ...
                                        sf = 1.05; angle = 182;
                                            ...
                                            sf = 1.06; angle = 182;
                                                        ...
                                                        sf = 1.05; angle = 183;
                                                            ...
                                                            sf = 1.05; angle = 270; % angle = 60;
                                                        else if (choice2 == 52)
                                                                sf = 1.05; angle = 184; %angle = -10;
                                                            else if (choice2 == 53)
                                                                    sf = 1.095; angle = 189;
                                                                else if (choice2 == 54)
                                                                        sf = 1.04; angle = 187;
...
if (choice == 1)
    if (choice2 == 50)
        startPixelCoordinates{1} = [622 + 1; 735 + 1];
            ...
            startPixelCoordinates{1} = [179 + 1; 350 + 1]; % 367
%             startPixelCoordinates{1} = [1310 + 1; 285 + 1]; % 367
        else if (choice2 == 52)
                startPixelCoordinates{1} = [465 + 1; 736 + 1];%[472 + 1; 735 + 1];
%                 startPixelCoordinates{1} = [895 + 1; 22 + 1];
            else if (choice2 == 57 || choice2 == 58)
                    startPixelCoordinates{1} = [1335 + 1; 735 + 1]; %1343
                end
            end
        end
    end
        ...
        if (choice2 == 5)
            startPixelCoordinates{2} = [872 + 1; 949 + 1];
                ...
                startPixelCoordinates{2} = [745 + 1; 1081 + 1]; %739
            else if (choice2 == 12)
...
%%
figure(5); set(figure(5),'position',[481 14 1114 799],'papertype','a3');
set(gcf,'position',[564 61 927 670]);
imshow(img); hold on;
...
legend('error-state KF with ZUPT aid','non-recursive Bayesian map-matching with MHT initialization','start','stop');
set(legend,'fontsize',18,'interpreter','latex',...
    'DefaultLegendAutoUpdate','off','location','southwest');
hold off;
hold on;
plot(mu(1,1),mu(2,1), 'ko','linewidth',2,'markerfacecolor','r','markeredgecolor','k','markersize',10);
plot(mu(1,end),mu(2,end), 'gs','linewidth',2,'markerfacecolor','g','markeredgecolor','k','markersize',10);
hold off;
% print('MHT_experiment_1','-dpdf','-opengl');
%%
