...
figure(2); h = set(gcf,'position',[285 378 1096 420]); l = 1.5;
...
ylabel('Acceleration magnitude ($m/s^2$)', 'interpreter', 'latex', 'fontsize', 15);
...
figure(4); set(gcf,'position',[285 378 1096 420]); l = 2;
...
ylabel('Gyro rate magnitude (rad/s)','interpreter','latex','fontsize',5);
set(gca,'gridlinestyle','--','position',[0.039 0.110 0.950 0.815]);
set(gca, 'XTickLabel', [0:2:24], 'FontSize', 16);
h = legend('$\dot{\omega }_i$','$T_{\dot{\omega_i}}$');
...
set(gca,'gridlinestyle','--','position',[0.039 0.110 0.950 0.815]);
h = legend('$C_1$ $(a_i)$','$C_2$ ($\sigma_{a_i})$','$C_3$ ($\dot{\omega}_i$)',...
    'stance $C_1 \& C_2 \& C_3$','stance (median)','steps detected');
...
figure(6); set(gcf,'position',[285 378 1095 420]);
subplot(211);
plot(time,accX,'k-','linewidth',1.7);
grid on; set(gca,'gridlinestyle','--');
set(gca, 'YTickLabel', {'','-20','0','20','40'}, 'FontSize', 14);
set(gca, 'XTickLabel', {'','','','','','','','','','','',''}, 'FontSize', 14);
ylabel('$m/s^2$','interpreter','latex','fontsize',18); h = legend('acceleration x');
set(h,'interpreter','latex', 'fontsize',16,'location','northwest');
axis([0 21.2 -40 40]); set(gca,'position',[0.0639    0.5357    0.9269    0.4121])
subplot(212);
...
xlabel('Time (s)','interpreter','latex','fontsize',18);
ylabel('$m/s^2$','interpreter','latex','fontsize',18); h = legend('acceleration y');
set(h,'interpreter','latex', 'fontsize',16,'location','northwest');
axis([0 21.2 -40 40]); set(gca,'position',[0.0639    0.1286    0.9269    0.4121])
...
figure(7); set(gcf,'position',[285 378 1095 420]);
subplot(2,1,1);
...
h = legend('velocity x', 'velocity x with ZUPT');
...
xlabel('Time (s)','interpreter','latex','fontsize',18);
ylabel('m/s','interpreter','latex','fontsize',18);
h = legend('velocity y', 'velocity y with ZUPT');
set(h,'interpreter','latex','location','southwest','fontsize',15);
set(gca, 'XTickLabel', [0:2:24], 'FontSize', 14);
